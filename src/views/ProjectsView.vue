        ...
        <div class="project-card-wrapper mt-36">
          <div class="project-showcase" v-for="project in projects" :key="project.id">
            <div class="pc-header mb-5">
                ...
                <p class="text-4xl font-semibold text-[#CCD6F6] cursor-pointer" @click="redirectURL(project)">{{ project.name }} 
...
const redirectURL = (data) => {
  ...
  return data.name === "Email Templates" ? router.push(data.url) : window.open(data.url, "_blank");
}
